...
PrecisionTarget::PrecisionTarget(System& system) :
    PluginBase(),
    _impl{std::make_unique<PrecisionTargetImpl>(system)}
{}

PrecisionTarget::PrecisionTarget(std::shared_ptr<System> system) :
    PluginBase(),
    _impl{std::make_unique<PrecisionTargetImpl>(system)}
{}
...
PrecisionTarget::Result PrecisionTarget::publish_position_relative(
    PositionLocal position_local, ObservationFrame observation_frame) const
{
    return _impl->publish_position_relative(position_local, observation_frame);
}
