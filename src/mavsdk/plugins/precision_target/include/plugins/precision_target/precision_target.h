...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/precision_target/precision_target.proto)
...
public:
    ...
    /**
     * @brief Target Observation Frame type.
     */
    enum class ObservationFrame {
        LocalNed, /**< @brief NED local tangent frame (x: North, y: East, z: Down) with origin fixed
                     relative to earth.. */
        BodyFrd, /**< @brief FRD local frame aligned to the vehicle's attitude (x: Forward, y:
                    Right, z: Down) with an origin that travels with vehicle.. */
    };

    /**
     * @brief Stream operator to print information about a `PrecisionTarget::ObservationFrame`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream&
    operator<<(std::ostream& str, PrecisionTarget::ObservationFrame const& observation_frame);
    ...
    friend bool operator==(
        const PrecisionTarget::PositionLocal& lhs, const PrecisionTarget::PositionLocal& rhs);
     ...
     */
    friend std::ostream&
    operator<<(std::ostream& str, PrecisionTarget::PositionLocal const& position_local);
     ...
     */
    Result publish_position_relative(
        PositionLocal position_local, ObservationFrame observation_frame) const;
