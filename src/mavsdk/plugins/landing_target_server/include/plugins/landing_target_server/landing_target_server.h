...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/landing_target_server/landing_target_server.proto)
...
public:
     ...
     */
    friend bool operator==(const LandingTargetServer::Position& lhs, const LandingTargetServer::Position& rhs);
     ...
     */
    friend std::ostream& operator<<(std::ostream& str, LandingTargetServer::Position const& position);
